...
## [1.6.8] - 2026-02-16
### 📝 Misc
- hwp.find에 (기존 글자색, 글자크기에 이어) 글꼴 검색 추가 : FaceName 파라미터

---
## [1.6.7] - 2026-02-14
### 📝 Misc
- hwp.is_empty_para 메서드가 pos (0, 0, 16)에서 오동작하는 관계로, 해당 로직 추가함

---
## [1.6.6] - 2025-09-20
### 📝 Misc
- hwp.find, find_replace, find_replace_all 메서드 파라미터 중 UseWildCards(아무개문자) 기본값을 1에서 0으로 변경함
